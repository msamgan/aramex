...
class Core
{
    ...
    public function initializeShipment($shipper , $consignee , $details)
    {
        $this->param['Shipments'] = [
            'Shipment' => [
                'Shipper'   => [
                    ...
                    'Contact'       => [
                        //'Department'            => $shipper->PersonName,
                        'PersonName'            => $shipper->PersonName,
                        //'Title'                 => $shipper->PersonName,
                ...
                'Consignee' => [
                    'Reference1'    => $consignee->UserPin, // for response
                    'Reference2'    => '', // for response
                    'AccountNumber' => '', //Account Number
                    'Contact'       => [
                        //'Department'            => $consignee->PersonName,//Person Name
                        'PersonName'            => $consignee->PersonName,//Person Name
                        //'Title'                 => $consignee->Title,//Person Name
        ...
        //print_r($this->param['Shipments']);exit;
    }
